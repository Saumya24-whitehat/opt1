...
(function (a) {
  ...
  x(
    ...
    function (a, h) {
      var u = a.format,
        t = h.getNestedProperty,
        n = h.pick,
        k;
      (function (a) {
        function y(d, e) {
          var c = d.indexOf("#each("),
            b = d.indexOf("#plural("),
            f = d.indexOf("["),
            q = d.indexOf("]");
          if (-1 < c) {
            q = d.slice(c).indexOf(")") + c;
            b = d.substring(0, c);
            f = d.substring(q + 1);
            q = d.substring(c + 6, q).split(",");
            c = Number(q[1]);
            d = "";
            if ((e = t(q[0], e)))
              for (
                c = isNaN(c) ? e.length : c,
                  c = 0 > c ? e.length + c : Math.min(c, e.length),
                  q = 0;
                q < c;
                ++q
              )
          ...
          if (-1 < b) {
            f = d.slice(b).indexOf(")") + b;
            b = d.substring(b + 8, f).split(",");
            switch (Number(t(b[0], e))) {
              case 0:
                d = n(b[4], b[1]);
                break;
              case 1:
          ...
          return -1 < f
            ? ((b = d.substring(0, f)),
              ...
              !isNaN(f) &&
                ...
                (0 > f
                  ? ((d = e[e.length + f]),
                    "undefined" === typeof d && (d = e[0]))
                  : ((d = e[f]),
                    "undefined" === typeof d && (d = e[e.length - 1]))),
        ...
        function g(d, e, c) {
          ...
          do {
            var z = b(d, q);
            var a = d.substring(q, z && z.begin - 1);
        ...
        function r(d, e) {
          d = d.split(".");
          for (var c = this.options.lang, b = 0; b < d.length; ++b)
            c = c && c[d[b]];
          return "string" === typeof c ? g(c, e, this) : "";
        }
        var m = [];
        a.compose = function (d) {
          -1 === m.indexOf(d) && (m.push(d), (d.prototype.langFormat = r));
          return d;
        };
        a.i18nFormat = g;
      })(k || (k = {}));
  ...
  x(
    ...
    function (a, h) {
      function u(a) {
        if ("function" === typeof k.MouseEvent)
          return new k.MouseEvent(a.type, a);
        if (n.createEvent) {
          var g = n.createEvent("MouseEvent");
          if (g.initMouseEvent)
            return (
              g.initMouseEvent(
                a.type,
      ...
      function t(a, g) {
        ...
        if (n.createEvent) {
          var y = n.createEvent("MouseEvent");
          if (y.initMouseEvent)
            return (
              y.initMouseEvent(
                a,
      ...
      return {
        ...
        cloneTouchEvent: function (a) {
          ...
          if ("function" === typeof k.TouchEvent)
            return (
              (g = new k.TouchEvent(a.type, {
                touches: g(a.touches),
        ...
        removeClass: function (a, g) {
          a.classList
            ...
            : (a.className = a.className.replace(new RegExp(g, "g"), ""));
        },
  ...
  x(
    ...
    function (a, h, w) {
      function u(b, f) {
        var d = f.type,
          e = b.hcEvents;
        r.createEvent && (b.dispatchEvent || b.fireEvent)
          ? b.dispatchEvent
            ? b.dispatchEvent(f)
            : b.fireEvent(d, f)
          : e && e[d]
      ...
      function n(b) {
        var c = b.chart,
          ...
          e = "Seconds";
        d.Seconds =
          ((b.dataMax || b.max || 0) - (b.dataMin || b.min || 0)) / 1e3;
        ...
        var a = d[e].toFixed("Seconds" !== e && "Minutes" !== e ? 1 : 0);
        return c.langFormat("accessibility.axis.timeRange" + e, {
          chart: c,
          axis: b,
          range: a.replace(".0", ""),
        });
      ...
      function k(b) {
        ...
        d = function (d) {
          return b.dateTime ? c.time.dateFormat(e, a[d]) : a[d].toString();
        };
      ...
      function g(b, c) {
        ...
        c !== b.renderTo &&
          c.parentNode &&
          c.parentNode !== r.body &&
          (Array.prototype.forEach.call(c.parentNode.childNodes, function (b) {
            b.hasAttribute("aria-hidden") || b.setAttribute("aria-hidden", !0);
          }),
          g(b, c.parentNode));
      }
      var r = a.doc,
        m = h.stripHTMLTagsFromString,
        d = w.defined,
        e = w.find,
        c = w.fireEvent;
      return {
        ...
        getSeriesFirstPointElement: E,
        getSeriesFromName: function (b, c) {
          return c
        ...
        scrollToPoint: function (b) {
          var f = b.series.xAxis,
            e = b.series.yAxis,
            a = f && f.scrollbar ? f : e;
          if ((f = a && a.scrollbar) && d(f.to) && d(f.from)) {
            e = f.to - f.from;
            if (d(a.dataMin) && d(a.dataMax)) {
              var g = a.toPixels(a.dataMin),
                m = a.toPixels(a.dataMax);
              b =
                (a.toPixels(b["xAxis" === a.coll ? "x" : "y"] || 0) - g) /
                (m - g);
            } else b = 0;
  ...
  x(
    ...
    function (a, h, w, t, n) {
      ...
      t = (function () {
        ...
        a.prototype.initBase = function (a, r) {
          this.chart = a;
          this.eventProvider = new w();
          this.domElementProvider = new h();
          this.proxyProvider = r;
          this.keyCodes = {
            left: 37,
            right: 39,
            up: 38,
        ...
        a.prototype.addEvent = function (a, r, m, d) {
          return this.eventProvider.addEvent(a, r, m, d);
        };
        a.prototype.createElement = function (a, r) {
          return this.domElementProvider.createElement(a, r);
        };
    ...
    function (a) {
      ...
      a = (function () {
        ...
        a.prototype.run = function (a) {
          var u = a.which || a.keyCode,
            k = this.response.noHandler,
            w = h(this.keyCodeMap, function (a) {
              return -1 < a[0].indexOf(u);
            });
          w
            ? (k = w[1].call(this, u, a))
            : 9 === u && (k = this.response[a.shiftKey ? "prev" : "next"]);
          return k;
        };
        return a;
      })();
  ...
  x(
    ...
    function (a, h, w, t, n) {
      ...
      return (function (a) {
        ...
        d.prototype.handleSVGTitleElement = function () {
          var d = this.chart,
            c = "highcharts-title-" + d.index,
            b = r(
              d.langFormat("accessibility.svgContainerTitle", {
                chartTitle: y(d),
              })
            );
          if (b.length) {
            var a = (this.svgTitleElement =
              this.svgTitleElement ||
              g.createElementNS("http://www.w3.org/2000/svg", "title"));
            a.textContent = b;
            a.id = c;
            d.renderTo.insertBefore(a, d.renderTo.firstChild);
          }
        };
        d.prototype.setSVGContainerLabel = function () {
          var d = this.chart,
            c = d.langFormat("accessibility.svgContainerLabel", {
              chartTitle: y(d),
            });
          d.renderer.box &&
            c.length &&
            d.renderer.box.setAttribute("aria-label", c);
        };
        d.prototype.setGraphicContainerAttrs = function () {
          var d = this.chart,
            c = d.langFormat("accessibility.graphicContainerLabel", {
              chartTitle: y(d),
            });
          c.length && d.container.setAttribute("aria-label", c);
        };
        d.prototype.setRenderToAttrs = function () {
          var d = this.chart,
            c = "disabled" !== d.options.accessibility.landmarkVerbosity,
            b = d.langFormat("accessibility.chartContainerLabel", {
              title: y(d),
              chart: d,
            });
          b &&
            (d.renderTo.setAttribute("role", c ? "region" : "group"),
            d.renderTo.setAttribute("aria-label", b));
        };
        d.prototype.makeCreditsAccessible = function () {
          var d = this.chart,
            c = d.credits;
          c &&
            (c.textStr &&
              c.element.setAttribute(
                "aria-label",
                d.langFormat("accessibility.credits", {
                  creditsStr: r(c.textStr),
                })
              ),
            u(d, c.element));
        };
      ...
      (function (h) {
        ...
        function y(b, c) {
          ...
          (c = c || b.element) &&
            ...
            c.focus(),
            d.hideBrowserFocusOutline && (c.style.outline = "none"));
        ...
        function r(b, c) {
          ...
          var d = this.getBBox(),
            f = t(b, 3),
            e = this.parentGroup,
            q = this.scaleX || (e && e.scaleX),
            h = this.scaleY || (e && e.scaleY);
          q = (q ? !h : h)
            ? Math.abs(q || h || 1)
            : (Math.abs(q || 1) + Math.abs(h || 1)) / 2;
          ...
          if ("text" === this.element.nodeName || D) {
            ...
            l = +this.attr("x");
            var v = +this.attr("y");
            isNaN(l) || (h = l - d.width * p.x - f);
            isNaN(v) || (r = v - d.height * p.y - f);
            D &&
              I &&
              ((D = B),
              (B = C),
              (C = D),
              isNaN(l) || (h = l - d.height * p.x - f),
              isNaN(v) || (r = v - d.width * p.y - f));
          }
          this.focusBorder = this.renderer
            .rect(h, r, B, C, parseInt(((c && c.r) || 0).toString(), 10) / q)
          ...
          this.renderer.styledMode ||
            this.focusBorder.attr({
              stroke: c && c.stroke,
              "stroke-width": ((c && c.strokeWidth) || 0) / q,
            });
          m(this, b, c);
          g(this);
        }
        function m(c) {
          for (var d = [], a = 1; a < arguments.length; a++)
            d[a - 1] = arguments[a];
          c.focusBorderUpdateHooks ||
            ((c.focusBorderUpdateHooks = {}),
            b.forEach(function (b) {
              b += "Setter";
              var a = c[b] || c._defaultSetter;
              c.focusBorderUpdateHooks[b] = a;
              c[b] = function () {
                var b = a.apply(c, arguments);
                c.addFocusBorder.apply(c, d);
                return b;
              };
            }));
        }
        ...
        function e(b) {
          b.focusBorderUpdateHooks &&
            (Object.keys(b.focusBorderUpdateHooks).forEach(function (c) {
              var d = b.focusBorderUpdateHooks[c];
              d === b._defaultSetter ? delete b[c] : (b[c] = d);
            }),
        ...
        h.compose = function (b, a) {
          -1 === c.indexOf(b) &&
            (c.push(b),
            (b = b.prototype),
            (b.renderFocusBorder = k),
            (b.setFocusToElement = y));
          -1 === c.indexOf(a) &&
            (c.push(a),
            (a = a.prototype),
            (a.addFocusBorder = r),
            (a.removeFocusBorder = d));
        };
      })(n || (n = {}));
      return n;
    }
  ...
  x(
    ...
    function (a, h, w, t, n) {
      var k = w.doc,
        u = t.addClass,
        y = t.visuallyHideElement,
        g = n.attr;
      return (function () {
        function r(a, d) {
          this.chart = a;
          this.domElementProvider = new h();
          this.announceRegion = this.addAnnounceRegion(d);
        }
        r.prototype.destroy = function () {
          this.domElementProvider.destroyCreatedElements();
        };
        r.prototype.announce = function (g) {
          var d = this;
          ...
          this.clearAnnouncementRegionTimer = setTimeout(function () {
            d.announceRegion.innerHTML = a.emptyHTML;
            delete d.clearAnnouncementRegionTimer;
          }, 1e3);
        };
        r.prototype.addAnnounceRegion = function (a) {
          var d =
          ...
          this.chart.styledMode ? u(e, "highcharts-visually-hidden") : y(e);
          d.appendChild(e);
          return e;
        };
        r.prototype.createAnnouncerContainer = function () {
          var a = this.chart,
            d = k.createElement("div");
          g(d, { "aria-hidden": !1, class: "highcharts-announcer-container" });
          d.style.position = "relative";
          a.renderTo.insertBefore(d, a.renderTo.firstChild);
          return (a.announcerContainer = d);
        };
        return r;
      })();
    }
  ...
  x(
    ...
    function (a) {
      function h(a) {
        return (a.annotations || []).reduce(function (a, h) {
          h.options && !1 !== h.options.visible && (a = a.concat(h.labels));
          return a;
        }, []);
      }
      function u(a) {
      ...
      function t(a) {
        ...
        var h = u(a),
          m = a.points
            ...
            .map(function (c) {
              var b =
                (c.accessibility && c.accessibility.valueDescription) ||
                (c.graphic &&
                  c.graphic.element &&
                  c.graphic.element.getAttribute("aria-label")) ||
                "";
              c = (c && c.series.name) || "";
              return (c ? c + ", " : "") + "data point " + b;
            })
            .filter(function (c) {
              return !!c;
            }),
          ...
          e =
            ...
            (1 < d ? "MultiplePoints" : d ? "SinglePoint" : "NoPoints");
        a = {
          annotationText: h,
          annotation: a,
          numPoints: d,
          annotationPoint: m[0],
          additionalAnnotationPoints: m.slice(1),
        };
        return g.langFormat(e, a);
      }
      function n(a) {
        return h(a).map(function (a) {
          return (a = k(E(t(a)))) ? "<li>" + a + "</li>" : "";
        });
      }
      var k = a.escapeStringForHTML,
        E = a.stripHTMLTagsFromString;
      return {
        ...
        getAnnotationLabelDescription: t,
  ...
  x(
    ...
    function (a, h, w, t, n, k, E, y, g, r) {
      function m(b, c) {
        var a = c[0],
          d = (b.series && b.series[0]) || {};
        d = {
        ...
        if (!a) return b.langFormat("accessibility.chartTypes.emptyChart", d);
        if ("map" === a)
          return d.mapTitle
            ? b.langFormat("accessibility.chartTypes.mapTypeDescription", d)
            : b.langFormat("accessibility.chartTypes.unknownMap", d);
        if (1 < b.types.length)
          return b.langFormat("accessibility.chartTypes.combinationChart", d);
        c = c[0];
        a = b.langFormat("accessibility.seriesTypeDescriptions." + c, d);
        var e = b.series && 2 > b.series.length ? "Single" : "Multiple";
        return (
          (b.langFormat("accessibility.chartTypes." + c + e, d) ||
            b.langFormat("accessibility.chartTypes.default" + e, d)) +
          (a ? " " + a : "")
        );
      }
      var d =
        ...
        e = t.getAnnotationsInfoHTML,
        c = k.getAxisDescription,
        b = k.getAxisRangeDescription,
        f = k.getChartTitle,
        q = k.unhideChartElementFromAT,
        z = E.format,
        u = y.doc,
        G = g.addClass,
        x = g.getElement,
        A = g.getHeadingTagNameForElement,
        F = g.stripHTMLTagsFromString,
      ...
      return (function (g) {
        ...
        p.prototype.init = function () {
          ...
          this.announcer = new w(b, "assertive");
        };
          ...
          this.screenReaderSections = {
            before: {
              ...
              buildContent: function (c) {
                ...
                return a ? a(c) : b.defaultBeforeChartFormatter(c);
              },
              insertIntoDOM: function (b, c) {
                c.renderTo.insertBefore(b, c.renderTo.firstChild);
              },
              afterInserted: function () {
                "undefined" !== typeof b.sonifyButtonId &&
                  b.initSonifyButton(b.sonifyButtonId);
                "undefined" !== typeof b.dataTableButtonId &&
            ...
            after: {
              ...
              buildContent: function (c) {
                var a =
                  c.options.accessibility.screenReaderSection
                    .afterChartFormatter;
                return a ? a(c) : b.defaultAfterChartFormatter();
              },
              insertIntoDOM: function (b, c) {
                c.renderTo.insertBefore(b, c.container.nextSibling);
              },
              afterInserted: function () {
                b.chart.accessibility &&
                  b.chart.accessibility.keyboardNavigation.updateExitAnchor();
              },
            },
          };
        };
        p.prototype.onChartRender = function () {
          var b = this;
          this.linkedDescriptionElement = this.getLinkedDescriptionElement();
          this.setLinkedDescriptionAttrs();
          Object.keys(this.screenReaderSections).forEach(function (c) {
            b.updateScreenReaderSection(c);
          });
        };
        p.prototype.getLinkedDescriptionElement = function () {
          var b = this.chart.options.accessibility.linkedDescription;
          if (b) {
            if ("string" !== typeof b) return b;
            b = z(b, this.chart);
            b = u.querySelectorAll(b);
            if (1 === b.length) return b[0];
          }
        };
        p.prototype.setLinkedDescriptionAttrs = function () {
          var b = this.linkedDescriptionElement;
          b &&
            (b.setAttribute("aria-hidden", "true"),
            G(b, "highcharts-linked-description"));
        };
        p.prototype.updateScreenReaderSection = function (b) {
          var c = this.chart,
            a = this.screenReaderSections[b],
            d = a.buildContent(c),
            l = (a.element = a.element || this.createElement("div")),
            e = l.firstChild || this.createElement("div");
          d
            ? (this.setScreenReaderSectionAttribs(l, b),
              n.setElementHTML(e, d),
              l.appendChild(e),
              a.insertIntoDOM(l, c),
              c.styledMode ? G(e, "highcharts-visually-hidden") : B(e),
              q(c, e),
              a.afterInserted && a.afterInserted())
            : (l.parentNode && l.parentNode.removeChild(l), delete a.element);
        };
        p.prototype.setScreenReaderSectionAttribs = function (b, c) {
          var a = this.chart,
            d = a.langFormat(
              "accessibility.screenReaderSection." + c + "RegionLabel",
              { chart: a, chartTitle: f(a) }
            );
          C(b, {
            id: "highcharts-screen-reader-region-" + c + "-" + a.index,
            "aria-label": d || void 0,
          });
          ...
          d &&
            b.setAttribute(
              "role",
              "all" === a.options.accessibility.landmarkVerbosity
                ? "region"
                : "group"
            );
        };
        p.prototype.defaultBeforeChartFormatter = function () {
          ...
          if (!c) return "";
          var d = this.getAxesDescription(),
            L =
              b.sonify &&
              b.options.sonification &&
              b.options.sonification.enabled,
            J = "highcharts-a11y-sonify-data-btn-" + b.index,
        ...
        p.prototype.defaultAfterChartFormatter = function () {
          ...
          if (!c) return "";
          var d = { endOfChartMarker: this.getEndOfChartMarkerText() };
          return a.i18nFormat(c, d, b).replace(/<(\w+)[^>]*?>\s*<\/\1>/g, "");
        };
        p.prototype.getLinkedDescription = function () {
          var b = this.linkedDescriptionElement;
          return F((b && b.innerHTML) || "");
        };
        p.prototype.getLongdescText = function () {
          var b = this.chart.options,
            c = b.caption;
          c = c && c.text;
          var a = this.getLinkedDescription();
          return b.accessibility.description || a || c || "";
        };
        p.prototype.getTypeDescriptionText = function () {
          var b = this.chart;
          return b.types
            ? b.options.accessibility.typeDescription || m(b, b.types)
            : "";
        };
        p.prototype.getDataTableButtonText = function (b) {
          var c = this.chart;
          c = c.langFormat("accessibility.table.viewAsDataTableButtonText", {
            chart: c,
            chartTitle: f(c),
          });
          return '<button id="' + b + '">' + c + "</button>";
        };
        p.prototype.getSonifyButtonText = function (b) {
          var c = this.chart;
          if (c.options.sonification && !1 === c.options.sonification.enabled)
            return "";
          c = c.langFormat("accessibility.sonification.playAsSoundButtonText", {
            chart: c,
            chartTitle: f(c),
          });
          return '<button id="' + b + '">' + c + "</button>";
        };
        p.prototype.getSubtitleText = function () {
          var b = this.chart.options.subtitle;
          return F((b && b.text) || "");
        };
        p.prototype.getEndOfChartMarkerText = function () {
          var b = this.chart,
            c = b.langFormat(
        ...
        p.prototype.onDataTableCreated = function (b) {
          var c = this.chart;
          if (c.options.accessibility.enabled) {
            this.viewDataTableButton &&
              this.viewDataTableButton.setAttribute("aria-expanded", "true");
            var a = b.tree.attributes || {};
            a.tabindex = -1;
            a.summary = c.langFormat("accessibility.table.tableSummary", {
              chart: c,
            });
            b.tree.attributes = a;
          }
        };
        p.prototype.focusDataTable = function () {
          var b = this.dataTableDiv;
          (b = b && b.getElementsByTagName("table")[0]) && b.focus && b.focus();
        };
        p.prototype.initSonifyButton = function (b) {
          var c = this,
            a = (this.sonifyButton = x(b)),
            d = this.chart,
            e = function (b) {
              a &&
        ...
        p.prototype.initDataTableButton = function (b) {
          var c = (this.viewDataTableButton = x(b)),
            a = this.chart;
          b = b.replace("hc-linkto-", "");
          c &&
            (C(c, { tabindex: -1, "aria-expanded": !!x(b) }),
            (c.onclick =
        ...
        p.prototype.getAxesDescription = function () {
          var b = this.chart,
            c = function (c, a) {
              c = b[c];
              return (
            ...
            a =
              !!b.types &&
              0 > b.types.indexOf("map") &&
              0 > b.types.indexOf("treemap") &&
              0 > b.types.indexOf("tilemap"),
            d = !!b.hasCartesianSeries,
            e = c("xAxis", !b.angular && d && a);
          c = c("yAxis", d && a);
          a = {};
          e && (a.xAxis = this.getAxisDescriptionText("xAxis"));
          c && (a.yAxis = this.getAxisDescriptionText("yAxis"));
          return a;
        };
        p.prototype.getAxisDescriptionText = function (a) {
          var d = this.chart,
            e = d[a];
          return d.langFormat(
            "accessibility.axis." +
            ...
            {
              chart: d,
              names: e.map(function (b) {
                return c(b);
              }),
              ranges: e.map(function (c) {
                return b(c);
              }),
              numAxes: e.length,
            }
  ...
  x(
    ...
    function (a, h, w, t, n, k) {
      var u =
        ...
        y = h.attr,
        g = n.getChartTitle,
        r = n.unhideChartElementFromAT,
        m = k.getFakeMouseEvent;
      h = (function (a) {
        function d() {
          return (null !== a && a.apply(this, arguments)) || this;
        }
        ...
        d.prototype.onMenuShown = function () {
          ...
          b && (this.addAccessibleContextMenuAttribs(), r(c, b));
          this.setExportButtonExpandedState("true");
        };
        d.prototype.setExportButtonExpandedState = function (c) {
        ...
        d.prototype.onChartRender = function () {
          ...
          this.exportButtonProxy &&
            ...
            b === c.exportingGroup &&
            (b.focusBorder
              ? c.setFocusToElement(b, this.exportButtonProxy.buttonElement)
              : a && a.keyboardNavigation.tabindexContainer.focus());
        };
        d.prototype.proxyMenuButton = function () {
          var c = this.chart,
            b = this.proxyProvider,
            a = c.exportSVGElements && c.exportSVGElements[0],
            d = c.options.exporting,
            e = c.exportSVGElements && c.exportSVGElements[0];
          d &&
            !1 !== d.enabled &&
            d.accessibility &&
            ...
            (this.exportButtonProxy = b.addProxyElement(
              ...
              { click: a },
              {
                "aria-label": c.langFormat(
                  ...
                  { chart: c, chartTitle: g(c) }
                ),
                "aria-expanded": !1,
                title: c.options.lang.contextButtonTitle || null,
              }
            ));
        };
        ...
        d.prototype.addAccessibleContextMenuAttribs = function () {
          var c = this.chart,
            b = c.exportDivElements;
          b &&
            b.length &&
            (b.forEach(function (b) {
              b &&
                ("LI" !== b.tagName || (b.children && b.children.length)
                  ? b.setAttribute("aria-hidden", "true")
          ...
          return new t(b, {
            ...
            init: function () {
              var c = a.exportButtonProxy,
                d = a.chart.exportingGroup;
              c && d && b.setFocusToElement(d, c.buttonElement);
            },
            terminate: function () {
              b.hideExportMenu();
            },
        ...
        d.prototype.onKbdPrevious = function (c) {
          ...
          for (var d = b.highlightedExportItemIx || 0; d--; )
            if (b.highlightExportItem(d)) return c.success;
          return a.keyboardNavigation.wrapAround
            ? (b.highlightLastExportItem(), c.success)
            : c.prev;
        };
        d.prototype.onKbdNext = function (c) {
          var b = this.chart,
            a = b.options.accessibility;
          c = c.response;
          for (
            ...
            if (b.highlightExportItem(d)) return c.success;
          return a.keyboardNavigation.wrapAround
            ? (b.highlightExportItem(0), c.success)
            : c.next;
        };
        d.prototype.onKbdClick = function (c) {
          var b = this.chart,
      ...
      (function (d) {
        function e() {
          var b = this.exportSVGElements && this.exportSVGElements[0];
          if (b && ((b = b.element), b.onclick)) b.onclick(m("click"));
        }
        function c() {
          ...
          b &&
            ...
            this.openMenu &&
            (b.forEach(function (b) {
              if (b && "highcharts-menu-item" === b.className && b.onmouseout)
                b.onmouseout(m("mouseout"));
            }),
        ...
        function b(b) {
          ...
          if (c && "LI" === c.tagName && (!c.children || !c.children.length)) {
            ...
            c.focus && d && c.focus();
            if (a && a.onmouseout) a.onmouseout(m("mouseout"));
            if (c.onmouseover) c.onmouseover(m("mouseover"));
        ...
        function f() {
          if (this.exportDivElements)
            for (var b = this.exportDivElements.length; b--; )
        ...
        d.compose = function (d) {
          -1 === q.indexOf(d) &&
            ...
            (d = a.prototype),
            (d.hideExportMenu = c),
            (d.highlightExportItem = b),
            (d.highlightLastExportItem = f),
            (d.showExportMenu = e));
        };
      })(h || (h = {}));
      return h;
    ...
    function (a, h, w, t, n) {
      ...
      w = (function () {
        ...
        a.prototype.init = function (a, e) {
          var c = this,
            b = (this.eventProvider = new t());
          this.chart = a;
          this.components = e;
          this.modules = [];
          this.currentModuleIx = 0;
          this.update();
          b.addEvent(this.tabindexContainer, "keydown", function (b) {
            return c.onKeydown(b);
          });
          b.addEvent(this.tabindexContainer, "focus", function (b) {
            return c.onFocus(b);
          });
          ["mouseup", "touchend"].forEach(function (a) {
            return b.addEvent(k, a, function () {
              return c.onMouseUp();
            });
          });
          ["mousedown", "touchstart"].forEach(function (d) {
            return b.addEvent(a.renderTo, d, function () {
              c.isClickingChart = !0;
            });
          });
        ...
        a.prototype.update = function (a) {
          ...
          d && d.enabled && a && a.length
            ? ((this.modules = a.reduce(function (b, a) {
                a = c[a].getKeyboardNavigation();
                return b.concat(a);
              }, [])),
        ...
        a.prototype.updateExitAnchor = function () {
          var a = r("highcharts-end-of-chart-marker-" + this.chart.index);
          this.removeExitAnchor();
          a
        ...
        a.prototype.move = function (a) {
          var d = this.modules && this.modules[this.currentModuleIx];
          d && d.terminate && d.terminate(a);
          this.chart.focusElement &&
            this.chart.focusElement.removeFocusBorder();
          this.currentModuleIx += a;
          if ((d = this.modules && this.modules[this.currentModuleIx])) {
            if (d.validate && !d.validate()) return this.move(a);
            if (d.init) return d.init(a), !0;
          }
          this.currentModuleIx = 0;
          this.exiting = !0;
        ...
        a.prototype.onFocus = function (a) {
          var d = this.chart;
          a = a.relatedTarget && d.container.contains(a.relatedTarget);
          this.exiting ||
        ...
        a.prototype.onKeydown = function (a) {
          ...
          if (d) {
            var b = d.run(a);
            b === d.response.success
              ? (c = !0)
              : b === d.response.prev
              ? (c = this.move(-1))
              : b === d.response.next && (c = this.move(1));
        ...
        a.prototype.updateContainerTabindex = function () {
          ...
          e.renderTo.hasAttribute("tabindex") &&
            (c.removeAttribute("tabindex"), (c = e.renderTo));
          this.tabindexContainer = c;
          var b = c.getAttribute("tabindex");
          a && !b
        ...
        a.prototype.makeElementAnExitAnchor = function (a) {
          var d = this.tabindexContainer.getAttribute("tabindex") || 0;
        ...
        a.prototype.addExitAnchorEventsToEl = function (a) {
          var d = this.chart,
            c = this;
          this.eventProvider.addEvent(a, "focus", function (b) {
            b = b || u.event;
            var a = !(
              (b.relatedTarget && d.container.contains(b.relatedTarget)) ||
              c.exiting
            );
            d.focusElement && delete d.focusElement;
            a
        ...
        a.prototype.getFirstValidModuleIx = function () {
          for (var a = this.modules.length, e = 0; e < a; ++e) {
            var c = this.modules[e];
            if (!c.validate || c.validate()) return e;
          }
          return null;
        };
      ...
      (function (r) {
        ...
        r.compose = function (b) {
          h.compose(b);
          -1 === c.indexOf(b) &&
            (c.push(b), (b.prototype.dismissPopupContent = d));
          -1 === c.indexOf(k) && (c.push(k), y(k, "keydown", e));
          return b;
        };
      })(w || (w = {}));
      return w;
  ...
  x(
    ...
    function (a, h, w, t, n, k, E, y) {
      ...
      function r(a, c) {
        c.setState(a ? "hover" : "", !0);
        ["legendGroup", "legendItem", "legendSymbol"].forEach(function (d) {
          (d = ((d = c[d]) && d.element) || d) &&
            b(d, a ? "mouseover" : "mouseout");
        });
      }
      var m =
          (this && this.__extends) ||
      ...
      a = (function (b) {
        ...
        a.prototype.init = function () {
          ...
          this.addEvent(w, "afterScroll", function () {
            this.chart === b.chart &&
              (b.proxyProvider.updateGroupProxyElementPositions("legend"),
              b.updateLegendItemProxyVisibility(),
              -1 < b.highlightedLegendItemIx &&
                this.chart.highlightLegendItem(b.highlightedLegendItemIx));
          });
          this.addEvent(w, "afterPositionItem", function (a) {
            this.chart === b.chart &&
              this.chart.renderer &&
              b.updateProxyPositionForItem(a.item);
          });
          this.addEvent(w, "afterRender", function () {
            this.chart === b.chart &&
              this.chart.renderer &&
              b.recreateProxies() &&
              z(function () {
                return b.proxyProvider.updateGroupProxyElementPositions(
                  "legend"
                );
        ...
        a.prototype.updateLegendItemProxyVisibility = function () {
          var b = this.chart,
            ...
            c = a.currentPage || 1,
            d = a.clipHeight || 0;
          (a.allItems || []).forEach(function (e) {
            if (e.a11yProxyElement) {
              var v = e.a11yProxyElement.element,
                f = !1;
              if (a.pages && a.pages.length) {
                f = e.pageIx || 0;
                var l = e._legendItemPos ? e._legendItemPos[1] : 0;
                e = e.legendItem
                  ? Math.round(e.legendItem.getBBox().height)
                  : 0;
                f = l + e - a.pages[f] > d || f !== c - 1;
              }
              f
                ? b.styledMode
                  ? H(v, "highcharts-a11y-invisible")
                  : (v.style.visibility = "hidden")
                : (A(v, "highcharts-a11y-invisible"),
                  (v.style.visibility = ""));
            }
          });
        };
        a.prototype.onChartRender = function () {
          g(this.chart) || this.removeProxies();
        };
        a.prototype.highlightAdjacentLegendPage = function (b) {
          var a = this.chart,
            c = a.legend;
          b = (c.currentPage || 1) + b;
          var d = c.pages || [];
          if (0 < b && b <= d.length) {
            d = c.allItems.length;
            for (var e = 0; e < d; ++e)
              if (c.allItems[e].pageIx + 1 === b) {
                a.highlightLegendItem(e) && (this.highlightedLegendItemIx = e);
                break;
              }
          }
        };
        a.prototype.updateProxyPositionForItem = function (b) {
          b.a11yProxyElement && b.a11yProxyElement.refreshPosition();
        };
        a.prototype.recreateProxies = function () {
        ...
        a.prototype.removeProxies = function () {
          this.proxyProvider.removeGroup("legend");
        };
        a.prototype.updateLegendTitle = function () {
          var b = this.chart,
            a = x(
              (
                (b.legend &&
                  b.legend.options.title &&
                  b.legend.options.title.text) ||
                ""
              ).replace(/<br ?\/?>/g, " ")
            );
          b = b.langFormat(
            "accessibility.legend.legendLabel" + (a ? "" : "NoTitle"),
            { chart: b, legendTitle: a, chartTitle: u(b) }
          );
          this.proxyProvider.updateGroupAttrs("legend", { "aria-label": b });
        };
        a.prototype.addLegendProxyGroup = function () {
        ...
        a.prototype.proxyLegendItems = function () {
          var b = this;
          ((this.chart.legend && this.chart.legend.allItems) || []).forEach(
            function (a) {
              a.legendItem && a.legendItem.element && b.proxyLegendItem(a);
            }
          );
        };
        a.prototype.proxyLegendItem = function (b) {
          if (b.legendItem && b.legendGroup) {
            ...
            b.a11yProxyElement = this.proxyProvider.addProxyElement(
              "legend",
              {
                click: b.legendItem,
                visual: (b.legendGroup.div ? b.legendItem : b.legendGroup)
                  .element,
              },
              { tabindex: -1, "aria-pressed": b.visible, "aria-label": a }
            );
          }
        };
        a.prototype.getKeyboardNavigation = function () {
          var b = this.keyCodes,
            a = this,
            c = this.chart;
          return new k(c, {
            keyCodeMap: [
              ...
              [
                [b.pageDown, b.pageUp],
                function (c) {
                  a.highlightAdjacentLegendPage(c === b.pageDown ? 1 : -1);
            ...
            init: function () {
              ...
              a.highlightedLegendItemIx = 0;
            },
            terminate: function () {
              a.highlightedLegendItemIx = -1;
              c.legend.allItems.forEach(function (b) {
                return r(!1, b);
              });
            },
          });
        };
        a.prototype.onKbdArrowKey = function (b, a) {
          var c = this.keyCodes,
            d = b.response,
            e = this.chart,
            v = e.options.accessibility,
            f = e.legend.allItems.length;
          a = a === c.left || a === c.up ? -1 : 1;
          if (e.highlightLegendItem(this.highlightedLegendItemIx + a))
            return (this.highlightedLegendItemIx += a), d.success;
          1 < f && v.keyboardNavigation.wrapAround && b.init(a);
          return d.success;
        };
        a.prototype.onKbdClick = function (b) {
          var a = this.chart.legend.allItems[this.highlightedLegendItemIx];
          a && a.a11yProxyElement && a.a11yProxyElement.click();
          return b.response.success;
        };
        a.prototype.shouldHaveLegendNavigation = function () {
          var b = this.chart,
            a = b.colorAxis && b.colorAxis.length,
            c = (b.options.legend || {}).accessibility || {};
          return !!(
            b.legend &&
            b.legend.allItems &&
      ...
      (function (b) {
        function a(b) {
          ...
          return d
            ? (f(c) && a[c] && r(!1, a[c]),
              (a = this.legend),
              (b = a.allItems[b].pageIx),
              (c = a.currentPage),
              "undefined" !== typeof b && b + 1 !== c && a.scroll(1 + b - c),
              (b = d.legendItem),
              (a = d.a11yProxyElement && d.a11yProxyElement.buttonElement),
              b && b.element && a && this.setFocusToElement(b, a),
              r(!0, d),
              !0)
            : !1;
        }
        function d(b) {
          ...
          this.chart.options.accessibility.enabled &&
            a &&
            a.a11yProxyElement &&
            a.a11yProxyElement.buttonElement.setAttribute(
              "aria-pressed",
              b.visible ? "true" : "false"
            );
        }
        var e = [];
        b.compose = function (b, f) {
          -1 === e.indexOf(b) &&
            (e.push(b), (b.prototype.highlightLegendItem = a));
          -1 === e.indexOf(f) && (e.push(f), c(f, "afterColorizeItem", d));
        };
      })(a || (a = {}));
      return a;
    }
  ...
  x(
    ...
    function (a, h, w, t, n) {
      function k(b) {
        var a = b.index;
        return b.series && b.series.data && l(a)
          ? D(b.series.data, function (b) {
              return !!(
                b &&
                "undefined" !== typeof b.index &&
                b.index > a &&
                b.graphic &&
                b.graphic.element
              );
      ...
      function y(b) {
        ...
        return !u(b) && !a.exposeAsGroupOnly;
      }
      function g(b) {
        var a =
        ...
        return !(
          !b.points ||
          !(
            b.points.length < a.pointNavigationEnabledThreshold ||
            !1 === a.pointNavigationEnabledThreshold
          )
        );
      }
      function r(b, a) {
        ...
        return I(a)
          ? F(
              a,
              e.valueDecimals || b.valueDecimals || c.valueDecimals || -1,
              d.decimalPoint,
      ...
      function d(b, a) {
        return b.chart.langFormat("accessibility.series." + a + "Description", {
          name: z(b[a]),
          series: b,
        });
      }
      function e(b, a, c) {
        ...
        return b.series.pointArrayMap.reduce(function (a, c) {
          a += a.length ? ", " : "";
          var f = r(b, p(b[c], b.options[c]));
          return a + (c + ": " + d + f + e);
        }, "");
      }
      function c(b) {
        var a = b.series,
          c = 1 < a.chart.series.length || a.options.name,
          d = b.series;
        var f = d.chart;
        var v = d.options.accessibility;
        v =
          (v && v.point && v.point.valueDescriptionFormat) ||
        ...
        if (d) {
          ...
          var z =
            ...
            m = h.options.accessibility.point || {};
          (g = g.xAxis && g.xAxis.dateTime)
            ? ((g = g.getXDateFormat(
                b.x || 0,
                h.options.tooltip.dateTimeLabelFormats
              )),
              (z =
                (z.dateFormatter && z.dateFormatter(b)) ||
                (m.dateFormatter && m.dateFormatter(b)) ||
                z.dateFormat ||
                m.dateFormat ||
                g),
              (h = h.time.dateFormat(z, b.x || 0, void 0)))
            : (h = void 0);
          z =
            (b.series.xAxis || {}).categories &&
            l(b.category) &&
            ("" + b.category).replace("<br/>", " ");
          m = b.id && 0 > b.id.indexOf("highcharts-");
          g = "x, " + b.x;
          h = b.name || h || z || (m ? b.id : g);
        } else h = "";
        z = l(b.index) ? b.index + 1 : "";
        m = b.series;
        var k = m.chart.options.accessibility.point || {},
          u =
            (m.chart.options.accessibility &&
              m.chart.options.accessibility.point) ||
            {},
          B = m.tooltipOptions || {};
        g = u.valuePrefix || k.valuePrefix || B.valuePrefix || "";
        k = u.valueSuffix || k.valueSuffix || B.valueSuffix || "";
        u = r(b, b["undefined" !== typeof b.value ? "value" : "y"]);
        m = b.isNull
          ? m.chart.langFormat("accessibility.series.nullPointValue", {
              point: b,
            })
          : m.pointArrayMap
          ? e(b, g, k)
        ...
        c = b.series.chart;
        d = q(b);
        h = { point: b, annotations: d };
        c = d.length
          ? c.langFormat("accessibility.series.pointAnnotationsDescription", h)
          : "";
        b.accessibility = b.accessibility || {};
        b.accessibility.valueDescription = f;
        return f + v + a + (c ? " " + c : "");
      }
      function b(b) {
        var a = y(b),
          d = g(b),
          e = b.chart.options.accessibility.point.describeNull;
        (a || d) &&
          b.points.forEach(function (d) {
            ...
            if (!(f = d.graphic && d.graphic.element)) {
              ...
              if ((f = d.isNull && !l && f)) {
                l = d.series;
                var v = k(d);
                l = (f = v && v.graphic) ? f.parentGroup : l.graph || l.group;
                v = v
                  ? { x: p(d.plotX, v.plotX, 0), y: p(d.plotY, v.plotY, 0) }
                  : { x: p(d.plotX, 0), y: p(d.plotY, 0) };
                v = d.series.chart.renderer.rect(v.x, v.y, 1, 1);
                v.attr({
                ...
                l && l.element
                  ? ((d.graphic = v),
                    (d.hasDummyGraphic = !0),
                    v.add(l),
                    l.element.insertBefore(v.element, f ? f.element : null),
                    (f = v.element))
                  : (f = void 0);
              }
            }
            l =
              d.options &&
              d.options.accessibility &&
              !1 === d.options.accessibility.enabled;
            f &&
              (d.isNull && !e
                ? f.setAttribute("aria-hidden", !0)
                : (f.setAttribute("tabindex", "-1"),
                  b.chart.styledMode || (f.style.outline = "none"),
                  a && !l
                    ? ((v = d.series),
                      (l = v.chart.options.accessibility.point || {}),
                      (v =
                        (v.options.accessibility &&
                          v.options.accessibility.point) ||
                        {}),
                      (d = C(
                        (v.descriptionFormatter && v.descriptionFormatter(d)) ||
                          (l.descriptionFormatter &&
                            l.descriptionFormatter(d)) ||
                          c(d)
                      )),
      ...
      function f(b) {
        var a = b.chart,
          ...
          e = m(b),
          f = function (c) {
            return a[c] && 1 < a[c].length && b[c];
          },
          l = b.index + 1,
          v = d(b, "xAxis"),
          q = d(b, "yAxis"),
          g = { seriesNumber: l, series: b, chart: a };
        c = 1 < c.length ? "Combination" : "";
        g =
          a.langFormat("accessibility.series.summary." + b.type + c, g) ||
          a.langFormat("accessibility.series.summary.default" + c, g);
        f =
          (f("yAxis") ? " " + q + "." : "") + (f("xAxis") ? " " + v + "." : "");
        return A(
      ...
      var q = a.getPointAnnotationTexts,
        z = h.getAxisDescription,
        M = h.getSeriesFirstPointElement,
        x = h.getSeriesA11yElement,
        H = h.unhideChartElementFromAT,
        A = w.format,
        F = w.numberFormat,
        B = t.reverseChildNodes,
        C = t.stripHTMLTagsFromString,
        D = n.find,
        I = n.isNumber,
        p = n.pick,
        l = n.defined;
      return {
        ...
        describeSeries: function (a) {
          ...
          if (e) {
            ...
            c = l.options.chart;
            d = 1 < l.series.length;
            l = l.options.accessibility.series.describeSingleSeries;
            var v = (a.options.accessibility || {}).exposeAsGroupOnly;
            (c.options3d && c.options3d.enabled && d) || !(d || l || v || u(a))
  ...
  x(
    ...
    function (a, h, w, t, n, k) {
      ...
      function y(a, b) {
        var c = (a || []).concat(b || []).reduce(function (b, a) {
          b[a.name + a.index] = a;
          return b;
        }, {});
      ...
      var g = h.addEvent,
        r = h.defined,
        m = t.getChartTitle,
        d = k.defaultPointDescriptionFormatter,
        e = k.defaultSeriesDescriptionFormatter;
      h = (function () {
        function c(b) {
        ...
        c.prototype.init = function () {
          var b = this.chart,
            a = b.options.accessibility.announceNewData.interruptUser
              ? "assertive"
              : "polite";
          this.lastAnnouncementTime = 0;
          this.dirty = { allSeries: {} };
          this.eventProvider = new n();
          this.announcer = new w(b, a);
        ...
        c.prototype.addEventListeners = function () {
          ...
          c.addEvent(a, "afterApplyDrilldown", function () {
            b.lastAnnouncementTime = 0;
          });
          c.addEvent(a, "afterAddSeries", function (a) {
            b.onSeriesAdded(a.series);
          });
          c.addEvent(a, "redraw", function () {
            b.announceDirtyData();
          });
        };
        c.prototype.onSeriesAdded = function (b) {
          this.chart.options.accessibility.announceNewData.enabled &&
            ((this.dirty.hasDirty = !0),
            (this.dirty.allSeries[b.name + b.index] = b),
            (this.dirty.newSeries = r(this.dirty.newSeries) ? void 0 : b));
        };
        c.prototype.announceDirtyData = function () {
          var b = this;
          if (
        ...
        c.prototype.queueAnnouncement = function (b, a, c) {
          ...
          if (e.enabled) {
            ...
            b = y(this.queuedAnnouncement && this.queuedAnnouncement.series, b);
            if ((a = this.buildAnnouncementMessage(b, a, c)))
              this.queuedAnnouncement &&
                clearTimeout(this.queuedAnnouncementTimer),
                (this.queuedAnnouncement = { time: f, message: a, series: b }),
        ...
        c.prototype.buildAnnouncementMessage = function (b, c, g) {
          var f = this.chart,
            q = f.options.accessibility.announceNewData;
          if (
            q.announcementFormatter &&
            ((b = q.announcementFormatter(b, c, g)), !1 !== b)
          )
          ...
          return f.langFormat("accessibility.announceNewData." + b, {
            chartTitle: q,
            seriesDesc: c ? e(c) : null,
            pointDesc: g ? d(g) : null,
            point: g,
            series: c,
          });
        };
      ...
      (function (a) {
        function b(b) {
          ...
          c &&
            ...
            (c.dirty.newPoint = r(c.dirty.newPoint) ? void 0 : b.point);
        }
        function c() {
          var b = this.chart,
            a = this.newDataAnnouncer;
          a &&
            a.chart === b &&
            b.options.accessibility.announceNewData.enabled &&
            ((a.dirty.hasDirty = !0),
            (a.dirty.allSeries[this.name + this.index] = this));
        }
        a.composedClasses = [];
        a.compose = function (d) {
          -1 === a.composedClasses.indexOf(d) &&
            (a.composedClasses.push(d),
            g(d, "addPoint", b),
            g(d, "updatedData", c));
        };
      })(h || (h = {}));
  ...
  x(
    ...
    function (a, h, w, t, n) {
      var k = a.doc,
        ...
        y = h.css,
        g = h.merge,
        r = t.fireEventOnWrappedOrUnwrappedElement,
        m = n.cloneMouseEvent,
        d = n.cloneTouchEvent,
      ...
      return (function () {
        function b(b, a, c, d) {
          ...
          c = "ul" === c;
          this.eventProvider = new w();
          var e = c ? k.createElement("li") : null,
            f = (this.buttonElement = k.createElement("button"));
          b.styledMode || this.hideButtonVisually(f);
          e
            ? (c && !b.styledMode && (e.style.listStyle = "none"),
              e.appendChild(f),
              (this.element = e))
            : (this.element = f);
          this.updateTarget(a, d);
        }
        b.prototype.click = function () {
          ...
          b.y += b.height / 2;
          b = e("click", b);
          r(this.target.click, b);
        };
        b.prototype.updateTarget = function (b, a) {
          this.target = b;
          ...
          u(
            this.buttonElement,
            g({ "aria-label": this.getTargetAttr(b.click, "aria-label") }, c)
          );
          this.eventProvider.removeAddedEvents();
          this.addProxyEventsToButton(this.buttonElement, b.click);
          this.refreshPosition();
        };
        b.prototype.refreshPosition = function () {
          var b = this.getTargetPosition();
        ...
        b.prototype.updateCSSClassName = function () {
          var b = this.chart.legend;
          b = b.group && b.group.div;
          b = -1 < ((b && b.className) || "").indexOf("highcharts-no-tooltip");
          var a =
            -1 <
        ...
        b.prototype.addProxyEventsToButton = function (b, a) {
          var c = this;
        ...
        b.prototype.hideButtonVisually = function (b) {
          y(b, {
            borderWidth: 0,
        ...
        b.prototype.getTargetPosition = function () {
          var b = this.target.click;
          b = b.element ? b.element : b;
          b = this.target.visual || b;
          if (this.chart.renderTo && b && b.getBoundingClientRect) {
            b = b.getBoundingClientRect();
            var a = this.chart.pointer.getChartPosition();
            return {
              x: (b.left - a.left) / a.scaleX,
              y: (b.top - a.top) / a.scaleY,
              width: b.right / a.scaleX - b.left / a.scaleX,
              height: b.bottom / a.scaleY - b.top / a.scaleY,
            };
          }
          return { x: 0, y: 0, width: 1, height: 1 };
        };
        b.prototype.getTargetAttr = function (b, a) {
          return b.element ? b.element.getAttribute(a) : b.getAttribute(a);
        };
        return b;
      })();
    }
  ...
  x(
    ...
    function (a, h, w, t, n, k) {
      var u = a.doc,
        y = h.attr,
        g = h.css,
        r = w.unhideChartElementFromAT,
        m = n.removeElement,
        d = n.removeChildNodes;
      return (function () {
        function a(a) {
          this.chart = a;
        ...
        a.prototype.addProxyElement = function (a, b, d) {
          var c = this.groups[a];
          if (!c)
            throw Error(
              "ProxyProvider.addProxyElement: Invalid group key " + a
            );
          a = new k(this.chart, b, c.type, d);
          c.proxyContainerElement.appendChild(a.element);
          c.proxyElements.push(a);
          return a;
        };
        a.prototype.addGroup = function (a, b, d) {
          var c = this.groups[a];
          if (c) return c.groupElement;
          c = this.domElementProvider.createElement(b);
          if (d && d.role && "div" !== b) {
          ...
          e.className =
            ...
            a.replace(/\W/g, "-");
          this.groups[a] = {
            proxyContainerElement: c,
            groupElement: e,
            type: b,
            proxyElements: [],
          };
          y(e, d || {});
          "ul" === b && c.setAttribute("role", "list");
        ...
        a.prototype.updateGroupProxyElementPositions = function (a) {
          (a = this.groups[a]) &&
            a.proxyElements.forEach(function (b) {
              return b.refreshPosition();
            });
        };
        a.prototype.destroy = function () {
          this.domElementProvider.destroyCreatedElements();
        ...
        a.prototype.getCurrentGroupOrderInDOM = function () {
          var a = this,
            ...
            d = b(this.beforeChartProxyPosContainer);
        ...
        a.prototype.isDOMOrderGroupOrder = function () {
          var a = this,
            ...
            e = b.length;
          if (e !== d.length) return !1;
          for (; e--; ) if (b[e] !== d[e]) return !1;
          return !0;
        };
        a.prototype.updatePosContainerPositions = function () {
          ...
          if (!a.renderer.forExport) {
            ...
            r(this.chart, this.afterChartProxyPosContainer);
            r(this.chart, this.beforeChartProxyPosContainer);
          }
        };
        return a;
      })();
  ...
  x(
    ...
    function (a, h, w, t, n, k) {
      function u(b) {
        if (-1 !== b.indexOf("%L")) return "text";
        var a = "aAdewbBmoyY".split("").some(function (a) {
            return -1 !== b.indexOf("%" + a);
          }),
          c = "HkIlMS".split("").some(function (a) {
            return -1 !== b.indexOf("%" + a);
          });
        return a && c ? "datetime-local" : a ? "date" : c ? "time" : "text";
      }
      ...
      var C = (function () {
        ...
        f.prototype.clickButton = function (b, c) {
          var e = this.chart,
            l = this.buttonOptions[b],
            f = e.xAxis[0],
            v = (e.scroller && e.scroller.getUnionExtremes()) || f || {},
            h = v.dataMin,
            p = v.dataMax,
            m = f && Math.round(Math.min(f.max, A(p, f.max))),
            r = l.type;
          v = l._range;
          var k,
            u = l.dataGrouping;
          if (null !== h && null !== p) {
            ...
            if ("month" === r || "year" === r)
              if (f) {
                r = { range: l, max: m, chart: e, dataMin: h, dataMax: p };
                var n = f.minFromRange.call(r);
                z(r.newMax) && (m = r.newMax);
              } else v = l;
            else if (v) (n = Math.max(m - v, h)), (m = Math.min(n + v, p));
            else if ("ytd" === r)
              if (f)
                "undefined" === typeof p &&
                  ((h = Number.MAX_VALUE),
                  ...
                  e.series.forEach(function (b) {
                    b = b.xData;
                    h = Math.min(b[0], h);
                    p = Math.max(b[b.length - 1], p);
                  }),
                  (c = !1)),
                  (m = this.getYTDExtremes(p, h, e.time.useUTC)),
                  (n = k = m.min),
                  (m = m.max);
              else {
              ...
              "all" === r &&
                f &&
                (e.navigator &&
                  e.navigator.baseSeries[0] &&
                  (e.navigator.baseSeries[0].xAxis.options.range = void 0),
                (n = h),
                (m = p));
            d(n) && (n += l._offsetMin);
            d(m) && (m += l._offsetMax);
            ...
            if (f)
              f.setExtremes(n, m, A(c, !0), void 0, {
                trigger: "rangeSelectorButton",
                rangeSelectorButton: l,
              });
            else {
              var t = B(e.options.xAxis)[0];
              var w = t.range;
              t.range = v;
              var F = t.min;
              t.min = k;
        ...
        f.prototype.init = function (b) {
          ...
          a.buttonOptions = d;
          this.eventsToUnbind = [];
          this.eventsToUnbind.push(g(b.container, "mousedown", f));
          this.eventsToUnbind.push(g(b, "resize", f));
          ...
          this.eventsToUnbind.push(
            g(b, "load", function () {
              b.xAxis &&
                b.xAxis[0] &&
                g(b.xAxis[0], "setExtremes", function (c) {
                  this.max - this.min !== b.fixedRange &&
        ...
        f.prototype.updateButtonStates = function () {
          var b = this,
            ...
            h = g.dataMin,
            p = g.dataMax;
          a = b.getYTDExtremes(p, h, a.time.useUTC);
          var m = a.min,
            q = a.max,
            r = b.selected,
            k = z(r),
            u = b.options.allButtonsEnabled,
            n = b.buttons;
          b.buttonOptions.forEach(function (a, l) {
            var v = a._range,
              g = a.type,
              J = a.count || 1,
              L = n[l],
              K = 0,
              N = a._offsetMax - a._offsetMin;
            a = l === r;
            var B = v > p - h,
              t = v < d.minRange,
              z = !1,
            ...
            v = v === e;
            ("month" === g || "year" === g) &&
            e + 36e5 >= 864e5 * { month: 28, year: 365 }[g] * J - N &&
            e - 36e5 <= 864e5 * { month: 31, year: 366 }[g] * J + N
              ? (v = !0)
              : "ytd" === g
              ? ((v = q - m + N === e), (z = !a))
              : "all" === g &&
                ((v = d.max - d.min >= p - h), (A = !a && k && v));
            g = !u && (B || t || A || f);
            J = (a && v) || (v && !k && !z) || (a && b.frozenStates);
            g ? (K = 3) : J && ((k = !0), (K = 2));
            L.state !== K &&
              (L.setState(K),
              c &&
                ((c.options[l + 1].disabled = g),
                2 === K && (c.selectedIndex = l + 1)),
              0 === K && r === l && b.setSelected());
          });
        };
        f.prototype.computeButtonRange = function (b) {
          ...
          if (d[a]) b._range = d[a] * c;
            ...
            b._range = 864e5 * { month: 30, year: 365 }[a] * c;
        ...
        f.prototype.setInputValue = function (b, a) {
          ...
          if (f) {
            var l = f.getAttribute("data-hc-time");
            l = d(l) ? Number(l) : void 0;
            d(a) &&
              (d(l) && f.setAttribute("data-hc-time-previous", l),
              f.setAttribute("data-hc-time", a),
              (l = a));
            f.value = e.dateFormat(
              this.inputTypeFormats[f.type] || c.inputEditDateFormat,
              l
            );
            b && b.attr({ text: e.dateFormat(c.inputDateFormat, l) });
          }
        };
        ...
        f.prototype.showInput = function (b) {
          ...
          if (
            ...
            m(b, {
              width: c ? a.width + (f ? -2 : 20) + "px" : "auto",
              height: c ? a.height - 2 + "px" : "auto",
              border: "2px solid silver",
            });
            c && f
              ? m(b, { left: e + a.x + "px", top: d + "px" })
              : m(b, {
                  left:
                    Math.min(
                      Math.round(a.x + e - (b.offsetWidth - a.width) / 2),
                      this.chart.chartWidth - b.offsetWidth
                    ) + "px",
                  top: d - (b.offsetHeight - a.height) / 2 + "px",
                });
          }
        };
        f.prototype.hideInput = function (b) {
          (b = "min" === b ? this.minInput : this.maxInput) &&
            m(b, { top: "-9999em", border: 0, width: "1px", height: "1px" });
        };
        f.prototype.defaultInputDateParser = function (b, a, c) {
          ...
          d = Date.parse(d);
          z(d) ||
            ((b = b.split("-")), (d = Date.UTC(F(b[0]), F(b[1]) - 1, F(b[2]))));
          c && a && z(d) && (d += c.getTimezoneOffset(d));
          return d;
        };
        f.prototype.drawInput = function (a) {
          function c() {
            ...
            var l = g.maxInput,
              v = g.minInput;
            b !== Number(n.getAttribute("data-hc-time-previous")) &&
              z(b) &&
              (n.setAttribute("data-hc-time-previous", b),
              q && l && z(f)
                ...
                : v &&
                  z(e) &&
                  (b < Number(v.getAttribute("data-hc-time"))
                    ? (b = void 0)
                    : b > e && (b = e)),
              "undefined" !== typeof b &&
                c.setExtremes(q ? b : c.min, q ? c.max : b, void 0, void 0, {
          ...
          var d = this.chart,
            ...
            l = d.renderer.style || {},
            h = d.renderer,
            p = d.options.rangeSelector,
            q = "min" === a,
            k = y.lang[q ? "rangeSelectorFrom" : "rangeSelectorTo"] || "";
          k = h
            .label(k, 0)
            .addClass("highcharts-range-label")
            .attr({ padding: k ? 2 : 0, height: k ? p.inputBoxHeight : 0 })
            .add(f);
          h = h
            .label("", 0)
          ...
          d.styledMode ||
            h.attr({ stroke: p.inputBoxBorderColor, "stroke-width": 1 });
          h.add(f);
          var n = r(
            "input",
          ...
          n.setAttribute("type", u(p.inputDateFormat || "%b %e, %Y"));
          d.styledMode ||
            (k.css(x(l, p.labelStyle)),
            h.css(x({ color: "#333333" }, l, p.inputStyle)),
            m(
              n,
              b(
                {
          ...
          n.onkeydown = function (b) {
            B = !0;
            (38 !== b.keyCode && 40 !== b.keyCode) || c();
          };
          n.onkeyup = function () {
            B = !1;
          };
          return { dateBox: h, input: n, label: k };
        };
        ...
        f.prototype.getYTDExtremes = function (b, a, c) {
          ...
          a = Math.max(a, c);
          e = e.getTime();
          return { max: Math.min(b || e, e), min: a };
        };
        f.prototype.render = function (b, a) {
          var c = this.chart,
            ...
            g = c.options,
            v = g.rangeSelector,
            l = A(g.chart.style && g.chart.style.zIndex, 0) + 1;
          g = v.inputEnabled;
          if (!1 !== v.enabled) {
            this.rendered ||
              ((this.group = e
            ...
            if (
              ...
              d(b.dataMin) &&
                ...
                this.setInputExtremes(
                  "min",
                  b.dataMin,
                  Math.min(b.dataMax, this.getInputValue("max")) - c
                ),
                this.setInputExtremes(
                  "max",
                  Math.max(b.dataMin, this.getInputValue("min")) + c,
                  b.dataMax
                )),
              this.inputGroup)
            ) {
              ...
              [
                ...
                if (b) {
                  ...
                  a && (b.attr({ x: h }), (h += a + v.inputSpacing));
                }
              });
            }
            this.alignElements();
        ...
        f.prototype.renderButtons = function () {
          ...
          g(m, "touchstart", function () {
            m.style.fontSize = "16px";
          });
          [
            [w.isMS ? "mouseover" : "mouseenter"],
            [w.isMS ? "mouseout" : "mouseleave"],
            ["change", "click"],
          ].forEach(function (c) {
            var d = c[0],
              e = c[1];
          ...
          this.chart.styledMode ||
            ...
            (f["stroke-width"] = A(f["stroke-width"], 0)));
          r(
            "option",
          ...
          this.buttonOptions.forEach(function (c, d) {
            r("option", { textContent: c.title || c.text }, void 0, m);
            a[d] = e
              .button(
                c.text,
                0,
              ...
              .attr({ "text-align": "center", width: p })
              .add(b.buttonGroup);
        ...
        f.prototype.alignElements = function () {
          ...
          var q = g.inputPosition,
            ...
            n = d.plotLeft;
          if (e && p && q) {
            var u = p.x - d.spacing[3];
            if (a) {
              this.positionButtons();
              if (!this.initialButtonGroupWidth) {
                var B = 0;
                h && (B += h.getBBox().width + 5);
                c.forEach(function (b, a) {
                  B += b.width;
                  a !== c.length - 1 && (B += g.buttonSpacing);
                });
            ...
            f &&
              ...
              "left" === q.align
                ? (u = n)
                : "right" === q.align && (u = -Math.max(d.axisOffset[1], -a)),
              f.align(
                {
                  y: q.y,
            ...
            e.align({ verticalAlign: r }, !0, d.spacingBox);
            f = e.alignAttr.translateY;
            a = e.getBBox().height + 20;
            k = 0;
            "bottom" === r &&
              ((k =
                (k = d.legend && d.legend.options) &&
                "bottom" === k.verticalAlign &&
                k.enabled &&
                !k.floating
                  ? d.legend.legendHeight + A(k.margin, 10)
                  : 0),
              (a = a + k - 20),
              (k =
                f -
            ...
            if ("top" === r)
              g.floating && (k = 0),
                d.titleOffset && d.titleOffset[0] && (k = d.titleOffset[0]),
                (k += d.margin[0] - d.spacing[0] || 0);
            else if ("middle" === r)
              if (q.y === p.y) k = f;
              else if (q.y || p.y)
                k = 0 > q.y || 0 > p.y ? k - Math.min(q.y, p.y) : f - a;
            e.translate(g.x, g.y + Math.floor(k));
            p = this.minInput;
            q = this.maxInput;
            f = this.dropdown;
            g.inputEnabled &&
              p &&
              q &&
              ((p.style.marginTop = e.translateY + "px"),
              (q.style.marginTop = e.translateY + "px"));
            f && (f.style.marginTop = e.translateY + "px");
          }
        };
        f.prototype.alignButtonGroup = function (b, a) {
          var c = this.chart,
            d = this.buttonGroup,
          ...
          "right" === e.align
            ? (g += b - f)
            : "center" === e.align && (g -= f / 2);
          d &&
            d.align(
              {
                y: e.y,
                width: A(a, this.initialButtonGroupWidth),
                align: e.align,
                x: g,
              },
              !0,
        ...
        f.prototype.positionButtons = function () {
          var b = this.buttons,
            ...
            c = this.options,
            d = this.zoomText,
            e = a.hasLoaded ? "animate" : "attr",
            f = c.buttonPosition,
            g = a.plotLeft,
            h = g;
          d &&
            "hidden" !== d.visibility &&
            (d[e]({ x: A(g + f.x, g) }), (h += f.x + d.getBBox().width + 5));
          this.buttonOptions.forEach(function (a, d) {
            if ("hidden" !== b[d].visibility)
              b[d][e]({ x: h }), (h += b[d].width + c.buttonSpacing);
            else b[d][e]({ x: g });
          });
        };
        f.prototype.handleCollision = function (b) {
          ...
          var p = function (a) {
              if (e && d) {
                ...
                return h + a > c && c + f > h && g.y < l.y + e.getBBox().height;
              }
              return !1;
            },
            q = function () {
              e &&
                ...
                e.attr({
                  translateX:
                    e.alignAttr.translateX + (c.axisOffset[1] >= -b ? 0 : -b),
          ...
          e && d
            ? l.align === g.align || p(this.initialButtonGroupWidth + 20)
              ? "responsive" === h
                ? (this.collapseButtons(b), p(f()) && q())
                : q()
        ...
        f.prototype.collapseButtons = function (b) {
          var a = this.buttons,
            ...
            l = function (b) {
              return {
                text: b ? b + " \u25be" : "\u25be",
                width: "auto",
                paddingLeft: A(f.buttonTheme.paddingLeft, h.padding, 8),
                paddingRight: A(f.buttonTheme.paddingRight, h.padding, 8),
              };
            };
          g && g.hide();
          var p = !1;
          c.forEach(function (b, c) {
            c = a[c];
            2 !== c.state ? c.hide() : (c.show(), c.attr(l(b.text)), (p = !0));
          });
          p ||
            (e && (e.selectedIndex = 0),
            a[0].show(),
            a[0].attr(l(this.zoomText && this.zoomText.textStr)));
          c = f.buttonPosition.align;
          this.positionButtons();
          ("right" !== c && "center" !== c) ||
            this.alignButtonGroup(
              b,
              a[this.currentButtonIndex()].getBBox().width
            );
          this.showDropdown();
        };
        f.prototype.expandButtons = function () {
          ...
          a.forEach(function (a, d) {
            ...
            d.attr({
              ...
              paddingLeft: A(c.buttonTheme.paddingLeft, "unset"),
              paddingRight: A(c.buttonTheme.paddingRight, "unset"),
            });
        ...
        f.prototype.currentButtonIndex = function () {
          var b = this.dropdown;
          return b && 0 < b.selectedIndex ? b.selectedIndex - 1 : 0;
        };
        f.prototype.showDropdown = function () {
          ...
          if (b && d) {
            var e = b.translateX;
            b = b.translateY;
            a = a[this.currentButtonIndex()].getBBox();
            m(d, {
        ...
        f.prototype.hideDropdown = function () {
          var b = this.dropdown;
          b &&
            (m(b, { top: "-9999em", width: "1px", height: "1px" }),
        ...
        f.prototype.getHeight = function () {
          var b = this.options,
            a = this.group,
            c = b.y,
            d = b.buttonPosition.y,
            e = b.inputPosition.y;
          if (b.height) return b.height;
          this.alignElements();
          b = a ? a.getBBox(!0).height + 13 + c : 0;
          a = Math.min(e, d);
          if ((0 > e && 0 > d) || (0 < e && 0 < d)) b += Math.abs(a);
          return b;
        };
        f.prototype.titleCollision = function (b) {
          return !(b.options.title.text || b.options.subtitle.text);
        };
        f.prototype.update = function (b) {
          var a = this.chart;
          x(!0, a.options.rangeSelector, b);
          this.destroy();
          this.init(a);
          this.render();
        };
        f.prototype.destroy = function () {
          var b = this,
            ...
            d = b.maxInput;
          b.eventsToUnbind &&
            (b.eventsToUnbind.forEach(function (b) {
              return b();
            }),
          ...
          G(
            ...
            function (a, d) {
              a &&
                ...
                (a instanceof n
                  ? a.destroy()
                  : a instanceof window.HTMLElement && c(a));
              a !== f.prototype[d] && (b[d] = null);
            },
            this
          );
        };
      ...
      a.prototype.minFromRange = function () {
        ...
        var h = A(this.dataMin, Number.MIN_VALUE);
        z(f) || (f = h);
        f <= h &&
          ((f = h),
          "undefined" === typeof g && (g = e(f, b.count)),
          (this.newMax = Math.min(f + g, this.dataMax)));
        z(c) || (f = void 0);
        return f;
      };
      if (!w.RangeSelector) {
        var D = [],
          I = function (b) {
            function a() {
              d &&
                ((c = b.xAxis[0].getExtremes()),
                (e = b.legend),
                (p = d && d.options.verticalAlign),
                z(c.min) && d.render(c.min, c.max),
                e.display &&
                  "top" === p &&
                  p === e.options.verticalAlign &&
                  ((h = x(b.spacingBox)),
                  (h.y =
            ...
            d &&
              (f(D, function (a) {
                ...
                D.push([
                  b,
                  [
                    g(b.xAxis[0], "afterSetExtremes", function (b) {
                      d && d.render(b.min, b.max);
                    }),
                    g(b, "redraw", a),
                  ],
                ]),
        ...
        g(h, "beforeRender", function () {
          ...
          a &&
            (z(a.deferredYTDClick) &&
              (a.clickButton(a.deferredYTDClick), delete a.deferredYTDClick),
            b.forEach(function (b) {
              b.updateNames();
              b.setScale();
            }),
        ...
        g(h, "update", function (b) {
          ...
          a &&
            ...
            (this.rangeSelector = b = new C(this)));
          this.extraTopMargin = this.extraBottomMargin = !1;
          b &&
            (I(this),
            (a =
              (a && a.verticalAlign) || (b.options && b.options.verticalAlign)),
            b.options.floating ||
              ("bottom" === a
                ? (this.extraBottomMargin = !0)
                : "middle" !== a && (this.extraTopMargin = !0)),
            this.extraBottomMargin !== c || this.extraTopMargin !== e) &&
            (this.isDirtyBox = !0);
        });
        g(h, "render", function () {
        ...
        g(h, "getMargins", function () {
          ...
          b &&
            ((b = b.getHeight()),
            this.extraTopMargin && (this.plotTop += b),
            this.extraBottomMargin && (this.marginBottom += b));
        });
        h.prototype.callbacks.push(I);
  ...
  x(
    ...
    function (a, h, w, t, n, k) {
      var u =
        ...
        y = w.unhideChartElementFromAT,
        g = w.getAxisRangeDescription,
        r = k.addEvent,
        m = k.attr;
      h = (function (a) {
        function d() {
        ...
        u(d, a);
        d.prototype.init = function () {
          this.announcer = new t(this.chart, "polite");
        };
        d.prototype.onChartUpdate = function () {
          var a = this.chart,
            b = this,
          ...
          d &&
            ...
            d.maxInput &&
              d.minInput &&
              ["minInput", "maxInput"].forEach(function (c, e) {
                if ((c = d[c]))
                  y(a, c),
          ...
          b && b.hasVisibleDropdown && d
            ? (y(a, d),
              e.forEach(function (b) {
                return b.element.setAttribute("aria-hidden", !0);
              }))
        ...
        d.prototype.setRangeButtonAttrs = function (a) {
          m(a.element, { tabindex: -1, role: "button" });
        };
        d.prototype.setRangeInputAttrs = function (a, b) {
          var c = this.chart;
          m(a, { tabindex: -1, "aria-label": c.langFormat(b, { chart: c }) });
        };
        d.prototype.onButtonNavKbdArrowKey = function (a, b) {
          var c = a.response,
            d = this.keyCodes,
            e = this.chart,
        ...
        d.prototype.initDropdownNav = function () {
          ...
          d &&
            e &&
            (b.setFocusToElement(d.buttonGroup, e),
            this.removeDropdownKeydownHandler &&
              this.removeDropdownKeydownHandler(),
            (this.removeDropdownKeydownHandler = r(e, "keydown", function (d) {
              var c = b.accessibility;
              (d.which || d.keyCode) === a.keyCodes.tab &&
                (d.preventDefault(),
                d.stopPropagation(),
                c &&
                  (c.keyboardNavigation.tabindexContainer.focus(),
                  c.keyboardNavigation.move(d.shiftKey ? -1 : 1)));
            })));
        };
      ...
      (function (d) {
        function e(b) {
          var a = (this.rangeSelector && this.rangeSelector.buttons) || [],
            d = this.highlightedRangeSelectorItemIx,
            c = this.rangeSelector && this.rangeSelector.selected;
          "undefined" !== typeof d &&
            a[d] &&
            d !== c &&
            a[d].setState(this.oldRangeSelectorItemState || 0);
          this.highlightedRangeSelectorItemIx = b;
          return a[b]
            ? (this.setFocusToElement(a[b].box, a[b].element),
              b !== c &&
                ((this.oldRangeSelectorItemState = a[b].state),
                a[b].setState(1)),
              !0)
            : !1;
        }
        function c() {
          var b = this.chart.accessibility;
          if (b && b.components.rangeSelector)
            return b.components.rangeSelector.onAfterBtnClick();
        }
        var b = [];
        d.compose = function (d, g) {
          -1 === b.indexOf(d) &&
            (b.push(d), (d.prototype.highlightRangeSelectorButton = e));
          -1 === b.indexOf(g) && (b.push(g), r(a, "afterBtnClick", c));
        };
      })(h || (h = {}));
      return h;
    }
        ...
        function r() {
          ...
          if (e) {
            if (
              (a.marker &&
                !1 === a.marker.enabled &&
                ((this.a11yMarkersForced = !0), k(this.options)),
              ...
              for (a = this.points.length; a--; ) {
                ...
                c.marker &&
                  ...
                  c.marker.enabled && !b
                    ? (u(!0, c.marker, {
                        states: { normal: { opacity: n(c) || 1 } },
                      }),
                      (e.hasForcedA11yMarker = !1))
                    : !1 === c.marker.enabled &&
                      (k(c), (e.hasForcedA11yMarker = !0)));
              }
          } else
    ...
    function (a, h, w, t, n, k, x, y) {
      ...
      w = (function () {
        ...
        b.prototype.init = function () {
          ...
          e.addEvent(c, "afterApplyDrilldown", function () {
            var a = d(this);
            a && a.highlight(!1);
          });
        ...
        b.prototype.onDrillupAll = function () {
          var a = this.lastDrilledDownPoint,
            b = this.chart,
            c = a && G(b, a.seriesName),
            e;
          a && c && q(a.x) && q(a.y) && (e = E(c, a.x, a.y));
          e = e || d(b);
        ...
        b.prototype.getKeyboardNavigationHandler = function () {
          ...
          return new k(f, {
            keyCodeMap: [
              [
                g ? [b.up, b.down] : [b.left, b.right],
                function (b) {
                  return a.onKbdSideways(this, b);
                },
              ],
              [
                g ? [b.left, b.right] : [b.up, b.down],
                function (b) {
        ...
        b.prototype.attemptHighlightAdjacentPoint = function (a, b) {
          var d = this.chart,
            f = d.options.accessibility.keyboardNavigation.wrapAround;
          return d.highlightAdjacentPoint(b)
            ? a.response.success
            : f && (b ? c(d) : e(d))
            ? a.response.success
      ...
      (function (a) {
        ...
        function d(a) {
          var b = this.highlightedPoint,
            c = Infinity,
            d;
          if (!q(b.plotX) || !q(b.plotY)) return !1;
        ...
        function k() {
          ...
          var c = a.length;
          if (a && c) {
            for (var d = b; d < c; ++d) if (!m(a[d])) return a[d].highlight();
            for (; 0 <= b; --b) if (!m(a[b])) return a[b].highlight();
          }
          return !1;
        }
        var l = [];
    ...
    function (a, h, w, t, n, k, x) {
      ...
      return (function (a) {
        ...
        d.prototype.init = function () {
          ...
          this.keyboardNavigation = new k(this.chart, this.keyCodes);
          this.keyboardNavigation.init();
          this.hideTooltipFromATWhenShown();
          this.hideSeriesLabelsFromATWhenShown();
        };
        d.prototype.hideTooltipFromATWhenShown = function () {
          var a = this;
        ...
        d.prototype.hideSeriesLabelsFromATWhenShown = function () {
    ...
    function (a, h, w, t, n) {
      ...
      a = (function (a) {
        ...
        h.prototype.onChartUpdate = function () {
          var a = this.chart,
            e = this;
          a.mapNavigation &&
            a.mapNavigation.navButtons.forEach(function (c, b) {
              u(a, c.element);
              e.setMapNavButtonAttrs(
                c.element,
                "accessibility.zoom.mapZoom" + (b ? "Out" : "In")
              );
            });
        };
        h.prototype.setMapNavButtonAttrs = function (a, e) {
          ...
          y(a, { tabindex: -1, role: "button", "aria-label": e });
        };
        h.prototype.onChartRender = function () {
        ...
        h.prototype.createZoomProxyButton = function (a, e, c) {
        ...
        h.prototype.onMapKbdArrow = function (a, e) {
          var c = this.keyCodes;
          this.chart[e === c.up || e === c.down ? "yAxis" : "xAxis"][0].panStep(
            e === c.left || e === c.up ? -1 : 1
          );
          return a.response.success;
        };
        h.prototype.onMapKbdTab = function (a, e) {
          ...
          e = c.mapNavigation.navButtons[this.focusedMapNavButtonIx];
          c.setFocusToElement(e.box, e.element);
          e.setState(2);
          return a.success;
        };
        h.prototype.onMapKbdClick = function (a) {
          this.fakeClickEvent(
        ...
        h.prototype.onMapNavInit = function (a) {
          var d = this.chart,
            c = d.mapNavigation.navButtons[0],
            b = d.mapNavigation.navButtons[1];
          c = 0 < a ? c : b;
          d.setFocusToElement(c.box, c.element);
          c.setState(2);
          this.focusedMapNavButtonIx = 0 < a ? 0 : 1;
        };
        h.prototype.simpleButtonNavigation = function (a, e, c) {
          var b = this.keyCodes,
            d = this,
            h = this.chart;
          return new t(h, {
            keyCodeMap: [
              [
                ...
                function (a, c) {
                  return this.response[
                    (a === b.tab && c.shiftKey) || a === b.left || a === b.up
                      ? "prev"
                      : "next"
                  ];
                },
              ...
              [
                ...
                function () {
                  var a = c(this, h);
                  return g(a, this.response.success);
                },
              ],
            ],
            validate: function () {
              return h[a] && h[a].box && d[e].buttonElement;
            },
            init: function () {
              h.setFocusToElement(h[a].box, d[e].buttonElement);
            },
          });
        };
        h.prototype.getKeyboardNavigation = function () {
          return [
      ...
      (function (a) {
        function g(a, e) {
          ...
          0 > a && b < e.dataMin
            ? ((b = e.dataMin), (c = b + d))
            : 0 < a && c > e.dataMax && ((c = e.dataMax), (b = c - d));
          this.setExtremes(b, c);
        }
        a.composedClasses = [];
        a.compose = function (d) {
          -1 === a.composedClasses.indexOf(d) &&
            (a.composedClasses.push(d), (d.prototype.panStep = g));
        };
      })(a || (a = {}));
      return a;
    }
    ...
    function (a) {
      ...
      return {
        isHighContrastModeActive: function () {
          ...
          if (t.matchMedia && a)
            return t.matchMedia("(-ms-high-contrast: active)").matches;
          if (u && t.getComputedStyle) {
            a = h.createElement("div");
            a.style.backgroundImage =
              "url(data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==)";
            h.body.appendChild(a);
            var k = (a.currentStyle || t.getComputedStyle(a)).backgroundImage;
            h.body.removeChild(a);
            return "none" === k;
          }
          return (
            t.matchMedia && t.matchMedia("(forced-colors: active)").matches
          );
        },
  ...
  x(
    ...
    function (a) {
        ...
        ["description", "typeDescription"].forEach(function (d) {
          ...
          g[d] &&
            ...
            x(
              ...
              !1,
              a,
              ((e = {}), (e["chart." + d] = "use accessibility." + d), e)
            ));
        });
      }
      function n(a) {
      ...
      function k(a) {
        ...
        a.series.forEach(function (k) {
          Object.keys(g).forEach(function (d) {
            var e,
              c = k.options[d];
            "accessibility.pointDescriptionFormatter" === d &&
              (c =
                k.options.accessibility &&
                k.options.accessibility.pointDescriptionFormatter);
            "undefined" !== typeof c &&
              (h(k.options, g[d], "skipKeyboardNavigation" === d ? !c : c),
              x(
                32,
                !1,
                a,
                ((e = {}), (e["series." + d] = "series." + g[d].join(".")), e)
              ));
          });
        });
      }
      ...
      return function (a) {
        ...
        n(a);
        a.series && k(a);
        u(a, ["accessibility"], ["accessibility"], {
        ...
        u(a, ["lang", "accessibility"], ["lang", "accessibility"], {
  ...
  x(
    ...
    function (a, h, w, t, n, k, x, y, g, r, m, d, e, c, b, f, q, z, M, G) {
      a = a.defaultOptions;
      var u = h.doc,
        A = w.addEvent,
        E = w.extend,
      ...
      (function (a) {
        ...
        function h(a) {
          if ((a = a.options.accessibility))
            a.customComponents &&
              ...
              C(!0, this.options.accessibility, a),
              this.accessibility &&
        ...
        var q = [];
        a.i18nFormat = t.i18nFormat;
        a.compose = function (a, l, p, v, w, x, z) {
          y.compose(l);
          m.compose(w);
          g.compose(l, p);
          r.compose(l);
          ...
          -1 === q.indexOf(l) &&
            (q.push(l),
            (l.prototype.updateA11yEnabled = n),
            A(l, "destroy", d),
            A(l, "render", f),
            A(l, "update", h),
          ...
          -1 === q.indexOf(v) && (q.push(v), A(v, "update", u));
          -1 === q.indexOf(w) &&
            (q.push(w),
      ...
      C(!0, a, z, { accessibility: { highContrastTheme: q }, lang: M });
      return h;
    }
  );
  x(
    ...
    function (a, h, w, t, n, k, x) {
      ...
      a.A11yChartUtilities = t;
      a.A11yHTMLUtilities = n;
      a.AccessibilityComponent = w;
      a.KeyboardNavigationHandler = k;
